...
import com.innprojects.smartbar.Activity.LoginActivityMachine;
...
/**
 * Created by simransarin on 04/10/17.
 */

public class LoginPOST_Machine extends AsyncTask<String, Void, String> {

    LoginActivityMachine mActivity;
    private ProgressDialog progressDialog;
    private String password;
    private String username;

    public LoginPOST_Machine(LoginActivityMachine loginActivity, String un, String pw){
