...
public class LogoutPOST_User extends AsyncTask<String, Void, String> {

    Boolean flag = false;
    private ProfileActivity mActivity;
    private FinalActivity finalActivity;

    public LogoutPOST_User(ProfileActivity profileActivity) {
        mActivity = profileActivity;
        flag = true;
    }

    public LogoutPOST_User(FinalActivity finalActivity) {
