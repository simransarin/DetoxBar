...
public class UserDrinkGET extends AsyncTask<String, Void, Prefed[]> {

    private PrefedActivity prefedActivity;
    private ProgressDialog progressDialog;

    public UserDrinkGET(PrefedActivity pActivity) {
        ...
        try {
            ...
            for (int i = 0; i < prefeds.length(); i++) {
                ...
                output[i] = new Prefed(name,ingredient_name_1,bottle_name_1,quantity_1,cost_per_ml_1,ingredient_name_2,bottle_name_2,quantity_2,cost_per_ml_2,
                        ...
                        ,ingredient_name_7,bottle_name_7,quantity_7,cost_per_ml_7,ingredient_name_8,bottle_name_8,quantity_8,cost_per_ml_8, "blue", "");
            }
            return output;
    ...
    protected void onPostExecute(Prefed[] prefeds) {
        ...
        if (prefeds != null) {
            prefedActivity.processResultsUser(prefeds);
        } else {
